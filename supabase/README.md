...
This directory contains database migrations and setup instructions for The House of Mourning project.
...
| `semantic_tags` | JSONB | Reserved for Phase 3 |
...
### Phase 3: Constellation Networks
The `semantic_tags` JSONB column is reserved for semantic similarity detection:
...
This will enable fast similarity lookups for connecting related grief messages.

### Phase 4+: Additional Features
- Moderation dashboard (update `flagged`, `approved` fields)
- Analytics (query by date ranges, common themes)
...
Questions? Check the main project README or contact:
- Lee Knight: lee@twoflaneurs.com
- VI Gorish: vig@twoflaneurs.com

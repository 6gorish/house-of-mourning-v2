          ...
          >
            ...
            >
              ...
              <p 
                ...
                style={{ color: 'rgba(180, 175, 190, 0.8)' }}
              >
                Truss House, RiNo Art Park, Denver
              </p>
              <p 
              ...
              >
                {userMessage 
                  ? 'Join us to see your contribution as part of the unveiled installation.'
            ...
            {MAILCHIMP_URL && (
              <div className="text-center mb-6">
                <p 
                  ...
                  style={{ color: 'rgba(160, 155, 170, 0.8)' }}
                >
                  Get updates about the exhibition
                </p>
                ...
                <a
                  ...
                  className="inline-block px-6 py-2 text-sm bg-white/10 border border-white/20 rounded text-white/90 hover:bg-white/15 hover:border-white/30 transition-colors"
                >

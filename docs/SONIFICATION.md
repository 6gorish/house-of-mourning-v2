...
As with the visual system, the audio technology should become invisible. Visitors should feel held, contemplative, perhaps moved—but they should never think "that's a nice oscillator." Every technical decision serves the emotional and sacred purpose of the installation.
...
The sonification system was developed by VI Gorish as part of The House of Mourning installation.

**Samples**: Field recordings by VI Gorish; Lidell vocal samples used under license.
